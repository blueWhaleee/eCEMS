...
public class Staff implements Serializable
{
    ...
    private String staff_number, password, full_name, profile_path;

    public Staff() { }

    public Staff(int staff_id, int campus_id, String staff_number, String password, String full_name, String profile_path)
    {
