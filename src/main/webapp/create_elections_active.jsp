            ...
            <div class="main__container">
                ...
                <div class="main__container__form">
                    <div class="main__container__form-title">
                        ...
                        <p>List of Candidates Information</p>
                    </div>
                     <table class="main__container__table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><div>40% (143 Votes)</div></td>
                                <td><div style="color: red;"><a href="#">Withdraw Candidate</a></div></td>
                            </tr>
                            <tr>
                                <td><div>AMER SYAFIQ BIN ABDUL RAZAK</div></td>
                                <td><div>40% (143 Votes)</div></td>
                            ...
                            <tr>
                                <td><div>AMER SYAFIQ BIN ABDUL RAZAK</div></td>
                                <td><div>40% (143 Votes)</div></td>
                                <td><div style="color: gray;">Withdrawn</div></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
